...
export type CreditTransactionType = 'grant' | 'purchase' | 'subscription_grant' | 'spend' | 'refund'

/** One `user_credits` row — the user's credit balance + subscription state. */
...
/** One `credit_transactions` ledger row (amount is signed: negative = spend). */
